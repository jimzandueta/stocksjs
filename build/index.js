...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"getFibRL\", function() { return getFibRL; });\n/* harmony import */ var _getPivotT__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./getPivotT */ \"./src/indicators/getPivotT.js\");\n/* harmony import */ var _getTrend__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./getTrend */ \"./src/indicators/getTrend.js\");\n\n\n\nvar getFibRL = function getFibRL(priceHist) {\n  var period = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 20;\n  var priceKeys = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : {\n    c: 'close',\n    h: 'high',\n    l: 'low'\n  };\n  var rs = [.236, .382, .5, .618, .786];\n  Object(_getPivotT__WEBPACK_IMPORTED_MODULE_0__[\"getPivotT\"])(priceHist, period, priceKeys);\n\n  var _loop = function _loop(i) {\n    if (i < priceHist.length - period) {\n      rs.forEach(function (r) {\n        var p1 = priceHist[i][\"s2\".concat(period)];\n        var p2 = priceHist[i][\"r2\".concat(period)];\n        priceHist[i][\"fib\".concat(r)] = p2 - Math.abs(p2 - p1) * r;\n      });\n    }\n  };\n\n  for (var i = 0; i < priceHist.length; i++) {\n    _loop(i);\n  }\n\n  return priceHist;\n};\n\n\n\n//# sourceURL=webpack:///./src/indicators/getFibRL.js?");

/***/ }),

/***/ "./src/indicators/getFisher.js":
/*!*************************************!*\
  !*** ./src/indicators/getFisher.js ***!
  \*************************************/
/*! exports provided: getFisher */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"getFisher\", function() { return getFisher; });\nfunction _toConsumableArray(arr) { return _arrayWithoutHoles(arr) || _iterableToArray(arr) || _unsupportedIterableToArray(arr) || _nonIterableSpread(); }\n\nfunction _nonIterableSpread() { throw new TypeError(\"Invalid attempt to spread non-iterable instance.\\nIn order to be iterable, non-array objects must have a [Symbol.iterator]() method.\"); }\n\nfunction _unsupportedIterableToArray(o, minLen) { if (!o) return; if (typeof o === \"string\") return _arrayLikeToArray(o, minLen); var n = Object.prototype.toString.call(o).slice(8, -1); if (n === \"Object\" && o.constructor) n = o.constructor.name; if (n === \"Map\" || n === \"Set\") return Array.from(o); if (n === \"Arguments\" || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(n)) return _arrayLikeToArray(o, minLen); }\n\nfunction _iterableToArray(iter) { if (typeof Symbol !== \"undefined\" && Symbol.iterator in Object(iter)) return Array.from(iter); }\n\nfunction _arrayWithoutHoles(arr) { if (Array.isArray(arr)) return _arrayLikeToArray(arr); }\n\nfunction _arrayLikeToArray(arr, len) { if (len == null || len > arr.length) len = arr.length; for (var i = 0, arr2 = new Array(len); i < len; i++) { arr2[i] = arr[i]; } return arr2; }\n\nvar getFisher = function getFisher(priceHist) {\n  var period = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 9;\n  var priceKeys = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : {\n    c: 'close',\n    h: 'high',\n    l: 'low'\n  };\n  var setKeys = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : {\n    t: 'fisherTransform',\n    s: 'fisherSignal'\n  };\n  //t = Fisher Transform\n  //s = Fisher Trigger\n  var hl2Arr = [];\n  var sto = 0;\n\n  for (var i = 0; i < priceHist.length; i++) {\n    priceHist[i]['hl2'] = (priceHist[i][priceKeys.h] + priceHist[i][priceKeys.l]) / 2;\n    hl2Arr.push(priceHist[i]['hl2']);\n  }\n\n  for (var _i = 0; _i < priceHist.length; _i++) {\n    var arr = hl2Arr.slice(_i, _i + period);\n    priceHist[_i]['hlMax'] = Math.max.apply(Math, _toConsumableArray(arr));\n    priceHist[_i]['hlMin'] = Math.min.apply(Math, _toConsumableArray(arr));\n  }\n\n  for (var _i2 = priceHist.length - 1; _i2 >= 0; _i2--) {\n    if (_i2 === priceHist.length - 1) {\n      priceHist[_i2]['fish'] = 0.0;\n      priceHist[_i2][setKeys.t] = 0.0;\n    } else {\n      sto = priceHist[_i2]['hlMax'] - priceHist[_i2]['hlMin'] != 0 ? (priceHist[_i2]['hl2'] - priceHist[_i2]['hlMin']) / (priceHist[_i2]['hlMax'] - priceHist[_i2]['hlMin']) : 0;\n      priceHist[_i2]['fish'] = Math.max(Math.min(0.33 * 2 * (sto - 0.5) + 0.67 * priceHist[_i2 + 1]['fish'], 0.999), -0.999);\n      priceHist[_i2][setKeys.t] = 0.5 * Math.log((1 + priceHist[_i2]['fish']) / (1 - priceHist[_i2]['fish'])) + 0.5 * priceHist[_i2 + 1][setKeys.t];\n      priceHist[_i2][setKeys.s] = priceHist[_i2 + 1][setKeys.t];\n    }\n  }\n\n  return priceHist;\n};\n\n\n\n//# sourceURL=webpack:///./src/indicators/getFisher.js?");

/***/ }),

/***/ "./src/indicators/getFisherCross.js":
/*!******************************************!*\
  !*** ./src/indicators/getFisherCross.js ***!
  \******************************************/
/*! exports provided: getFisherCross */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"getFisherCross\", function() { return getFisherCross; });\n/* harmony import */ var _getFisher__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./getFisher */ \"./src/indicators/getFisher.js\");\n\n\nvar getFisherCross = function getFisherCross(priceHist) {\n  var period = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 9;\n  var priceKeys = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : {\n    c: 'close',\n    h: 'high',\n    l: 'low'\n  };\n  var isWithFisherT = priceHist[0].hasOwnProperty('fisherTransform');\n  priceHist = !isWithFisherT ? Object(_getFisher__WEBPACK_IMPORTED_MODULE_0__[\"getFisher\"])(priceHist, period, priceKeys) : priceHist;\n  var arr = [];\n  var cIdx = 0;\n\n  for (var i = 0; i < priceHist.length; i++) {\n    var a = priceHist[cIdx].fisherTransform > priceHist[cIdx].fisherSignal;\n    var b = priceHist[i].fisherTransform > priceHist[i].fisherSignal;\n\n    if (!a != !b) {\n      priceHist[i - cIdx - 1]['days'] = i - cIdx - 1;\n      arr.push(priceHist[i - cIdx - 1]);\n      cIdx = i;\n    }\n  }\n\n  return arr;\n};\n\n\n\n//# sourceURL=webpack:///./src/indicators/getFisherCross.js?");
...
/***/ "./src/indicators/getSTS.js":
/*!**********************************!*\
  !*** ./src/indicators/getSTS.js ***!
  \**********************************/
/*! exports provided: getSTS */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"getSTS\", function() { return getSTS; });\n/* harmony import */ var _getSMA__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./getSMA */ \"./src/indicators/getSMA.js\");\n\n\nvar getSTS = function getSTS(priceHist) {\n  var period = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 14;\n  var priceKeys = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : {\n    c: 'close',\n    h: 'high',\n    l: 'low'\n  };\n  var setKey = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : {\n    k: 'stsK',\n    d: 'stsD'\n  };\n  var arrH = [];\n  var arrL = [];\n  var hP, lP;\n\n  for (var i = 0; i < priceHist.length - period; i++) {\n    arrH = [];\n    arrL = [];\n\n    for (var j = i; j < i + period; j++) {\n      arrH.push(priceHist[j][priceKeys.h]);\n      arrL.push(priceHist[j][priceKeys.l]);\n    }\n\n    hP = arrH.sort().pop();\n    lP = arrL.sort().reverse().pop();\n    priceHist[i][setKey.k] = (priceHist[i][priceKeys.c] - lP) / (hP - lP) * 100;\n  }\n\n  priceHist = Object(_getSMA__WEBPACK_IMPORTED_MODULE_0__[\"getSMA\"])(priceHist, 3, setKey.k, setKey.d);\n  return priceHist;\n};\n\n\n\n//# sourceURL=webpack:///./src/indicators/getSTS.js?");
...
/***/ "./src/indicators/getTRIX.js":
/*!***********************************!*\
  !*** ./src/indicators/getTRIX.js ***!
  \***********************************/
/*! exports provided: getTRIX */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"getTRIX\", function() { return getTRIX; });\n/* harmony import */ var _getEMA__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./getEMA */ \"./src/indicators/getEMA.js\");\n\n\nvar getTRIX = function getTRIX(priceHist) {\n  var period = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 18;\n  var priceKey = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : 'close';\n  var setKey = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : 'trix';\n  priceHist = Object(_getEMA__WEBPACK_IMPORTED_MODULE_0__[\"getEMA\"])(priceHist, period, null, priceKey, 'ema1S');\n  priceHist = Object(_getEMA__WEBPACK_IMPORTED_MODULE_0__[\"getEMA\"])(priceHist, period, period, \"ema1S\".concat(period), 'ema2S');\n  priceHist = Object(_getEMA__WEBPACK_IMPORTED_MODULE_0__[\"getEMA\"])(priceHist, period, period * 2, \"ema2S\".concat(period), 'ema3S');\n\n  for (var i = 0; i < priceHist.length; i++) {\n    if (i < priceHist.length - 1) {\n      priceHist[i][setKey] = (priceHist[i][\"ema3S\".concat(period)] - priceHist[i + 1][\"ema3S\".concat(period)]) / priceHist[i + 1][\"ema3S\".concat(period)] * 100;\n    } else {\n      priceHist[i][setKey] = 0;\n    }\n  }\n\n  return priceHist;\n};\n\n\n\n//# sourceURL=webpack:///./src/indicators/getTRIX.js?");
...
/***/ "./src/indicators/getWilliamsR.js":
/*!****************************************!*\
  !*** ./src/indicators/getWilliamsR.js ***!
  \****************************************/
/*! exports provided: getWilliamsR */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"getWilliamsR\", function() { return getWilliamsR; });\nvar getWilliamsR = function getWilliamsR(priceHist) {\n  var period = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 14;\n  var priceKeys = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : {\n    c: 'close',\n    h: 'high',\n    l: 'low'\n  };\n  var setKey = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : 'williamsR';\n  var arrH = [];\n  var arrL = [];\n  var hP, lP;\n\n  for (var i = 0; i < priceHist.length - period; i++) {\n    arrH = [];\n    arrL = [];\n\n    for (var j = i; j < i + period; j++) {\n      arrH.push(priceHist[j][priceKeys.h]);\n      arrL.push(priceHist[j][priceKeys.l]);\n    }\n\n    hP = arrH.sort().pop();\n    lP = arrL.sort().reverse().pop();\n    priceHist[i][setKey] = (hP - priceHist[i][priceKeys.c]) / (hP - lP) * -1;\n  }\n\n  return priceHist;\n};\n\n\n\n//# sourceURL=webpack:///./src/indicators/getWilliamsR.js?");
